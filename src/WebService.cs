...
//  и страница «Смета.html» работает с теми же данными, что и программа:
//  прайс-листом, наборами услуг, реквизитами и сметой. Браузер не может
...
//    GET  /api/state         — смета: отметки, количества, цены
//    POST /api/state         — сохранить смету
// ---------------------------------------------------------------------------
...
namespace KotovCalc
{
    /// <summary>Хранилище смет (отметки и количества) — общее для всех клиентов.</summary>
    internal interface IEstimateStore
    {
        /// <summary>Смета в виде словаря для передачи по сети.</summary>
