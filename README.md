...
Оплата фиксируется по номеру заявки, поэтому её можно внести и после сохранения
заявки. Если заплатили меньше суммы заявки, программа показывает остаток к доплате.
